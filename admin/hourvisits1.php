...
<html>
  ...
  <script src="https://code.jquery.com/ui/1.13.1/jquery-ui.js"></script>
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.css"></link>
		<script src="../js/hourvisits.js"></script>
	...
	<body>
		...
		<form  id = "search_form" style = "margin:50px">
			...
			<center>
                <div class = "row">
                    <div class = "col-lg-3" style="width:200px; margin-left:485px;">
						...
						<div class = "form-group">
							<button class = "btn btn-block btn-primary" id = "search">Search</button>
						</div>
                ...
                <div class = "row">
                    <div class ="col-lg-9 col-lg-offset-3" style="margin-left: 425px;">
                        <div class="form-check" style = "display:none" id="visitDiv">
                            ...
                            <label class="form-check-label">Number variation of visits per hour</label>
                        </div>
                    </div>
                ...
                <div class = "row">
                    <div class ="col-lg-9 col-lg-offset-3" style="margin-left: 425px;">
                            <div class="form-check"style = "display:none" id="casesDiv">
                                ...
                                <label class="form-check-label">Number variation of diagnosed cases visits per hour</label>
                            </div>
                    </div>
                </div>
